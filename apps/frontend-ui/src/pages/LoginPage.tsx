    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center py-24 px-6 lg:px-8 bg-gray-50 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          ...
          <div className="absolute -bottom-24 left-1/2 w-96 h-96 bg-indigo-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">
              Heureux de vous revoir sur ModernBlog
            </p>
          </div>
